...
def usage():
    ...
    print("       (Note that ""../"" is to avoid generate SHA-1 item of itself.)")
    ...
    print("    4. Copy all the above output files to the directory of this Python file.")
    print("    5. Run this tool using command")
